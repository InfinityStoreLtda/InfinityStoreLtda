<?php
// configuracoes/empresas/despesas/index.php - Lista empresas pagáveis (despesas)

include_once __DIR__ . '/../../../config.php';
verificarLogin();

$stmt = $pdo->query("SELECT * FROM empresas_pagaveis WHERE status = 'ativo' ORDER BY nome_empresa");
...
<head>
    ...
    <title>Empresas de Despesas</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <style>
        body { font-family: Arial, sans-serif; margin: 0; background: #f4f7fc; }
        .container { margin-left: 270px; padding: 20px; transition: margin-left 0.3s ease; }
        h2 { color: #2c3e50; }
        .add-btn { display:inline-block; padding:10px 15px; background:#3498db; color:#fff; border-radius:5px; margin-bottom:15px; text-decoration:none; }
        .add-btn:hover { background:#2c3e50; }
        table { border-collapse:collapse; width:100%; background:#fff; border-radius:8px; box-shadow:0 2px 10px rgba(0,0,0,.1); }
        ...
        @media (max-width:768px){ .container{ margin-left:90px; } }
    </style>
</head>
<body>
    <?php include_once __DIR__ . '/../../../sidebar.php'; ?>
    <div class="container">
        <h2>Empresas de Despesas</h2>
