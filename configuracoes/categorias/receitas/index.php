<?php
// configuracoes/categorias/receitas/index.php - Lista categorias de receitas

include_once __DIR__ . '/../../../config.php';
verificarLogin();

$stmt = $pdo->query("SELECT * FROM categorias WHERE tipo = 'receita' AND status = 'ativo' ORDER BY nome");
