<?php
// configuracoes/categorias/receitas/editar.php - Editar categoria de receitas

include_once __DIR__ . '/../../../config.php';
verificarLogin();

$id = $_GET['id'];
$stmt = $pdo->prepare("SELECT * FROM categorias WHERE id = :id AND tipo = 'receita'");
$stmt->execute(['id' => $id]);
...
<head>
    ...
    <title>Editar Categoria de Receita</title>
