...
class Contract extends BaseModel {
  public function paginate(int $page=1, int $per=20){
    $off = ($page-1)*$per;
  ...
  public function addItem(int $contratoId, array $item){
