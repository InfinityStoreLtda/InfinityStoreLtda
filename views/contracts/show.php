...
<p><strong>Número:</strong> <?=htmlspecialchars($c['numero'] ?? '-')?> · <strong>Processo:</strong> <?=htmlspecialchars($c['processo'] ?? '-')?> · <strong>Empenho:</strong> <?=htmlspecialchars($c['empenho'] ?? '-')?></p>
<p><strong>Vigência:</strong> <?=htmlspecialchars($c['vigencia_inicio'])?> → <?=htmlspecialchars($c['vigencia_fim'] ?? '-')?> · <strong>Centro de Custo:</strong> <?=htmlspecialchars($c['centro_custo'] ?? '-')?></p>
